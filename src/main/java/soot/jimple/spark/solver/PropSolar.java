...
import soot.jimple.spark.solver.myreflection.MyReflectionAnalysis;
...
public class PropSolar extends Propagator {
  ...
  public void addValuePointsTo(SootMethod container, Value value, Node obj) {
  ...
  public void propagate() {
    ...
    do {
      ...
      while (!varNodeWorkList.isEmpty()) {
        ...
        PointsToSetInternal newSet = src.getP2Set().getNewSet();

        varNodeWorkList.remove(src);
        handleVarNode(src);
        myReflectionAnalysis.onNewPointsToSet(src, newSet);
